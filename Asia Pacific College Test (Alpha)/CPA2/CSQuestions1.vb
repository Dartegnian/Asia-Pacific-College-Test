Public Class CSQuestions1
    Shared CSScore As Integer
    Dim selectedCount As Integer
    Dim csqSet2

    Private Function checkSelections()
        If (selectedCount = 5) Then
            Form1.NextPage.Enabled = True
        End If
    End Function
    ...
    Private Sub CSQuestions1_Load(sender As Object, e As EventArgs) Handles Me.Load
        CSScore = CSQuestions2.getScore()
        Form1.CurrentCSScore.Text = CSScore
    End Sub
End Class